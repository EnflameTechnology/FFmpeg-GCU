...
enum AVPixelFormat {
    ...
    AV_PIX_FMT_RGB24P,     ///< planar RGB 8:8:8, 24bpp, RRR...GGG...BBB...
    AV_PIX_FMT_BGR24P,     ///< planar BGR 8:8:8, 24bpp, BBB...GGG...RRR...
    ...
    /**
     * HW acceleration through EFC. data[i] contain CUdeviceptr pointers
     * exactly as for system memory frames.
     */
    AV_PIX_FMT_EFCCODEC,
    ...
    AV_PIX_FMT_P010LE_EF, ///< like NV12, with 10bpp per component, little-endian
